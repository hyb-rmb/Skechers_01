...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(117,287,0.7705,0.7705);
	...
	// Layer_14
	this.instance_3 = new lib.model_1();
	this.instance_3.setTransform(167.6,329.9,2.0856,2.0856,-3.4957);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(19).to({_off:false},0).to({scaleX:1.3082,scaleY:1.3082,rotation:0,x:160,y:257.85},15).wait(19).to({regX:0.1,regY:0.1,scaleX:1.0779,scaleY:1.0779,x:158.15,y:212.85},11).wait(51));
